	...
	<div style="margin-left: 25%; padding: 1px 16px; height: 1000px;">
		<div style="margin-top: 70px;">
			...
			<form action="search" method="post"
				...
				<input type="text" name="mykey" placeholder="请输入项目名称"> <input
		...
		<table class="bordered" cellspacing="0" border="0">
			...
			<c:forEach items="${projectList}" var="project">
				<tr>
					<td>${project.name}</td>
					<td>${project.price}</td>
					<td><a href="a_updproById?id=${project.id}" class="button">修改</a></td>
					<td><a href="a_delproById?id=${project.id}" class="button"
